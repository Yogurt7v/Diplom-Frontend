...
import  { addReportFetch } from "../../fetchs/addReport";
...
export const ReportPage = () => {
    ...
    return (
        <div>
            ...
            <textarea className={style.ReportTextarea} onChange={(e) => setReportText(e.target.value)} ref={ref}></textarea>
            <button onClick={() => report()} className={style.ReportButton}>Отправить</button>
            </div>
        </div>
    )
}